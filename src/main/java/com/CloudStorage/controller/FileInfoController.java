...
public class FileInfoController extends CommonFileController {
    ...
    public ResponseVO loadDataList(HttpSession session, FileInfoQuery query, String category) {
        ...
        return getSuccessResponseVO(
                // PaginationResultVO对象转化为FileInfoVO对象返回，减少信息量，防止隐私泄露
    ...
    public ResponseVO uploadFile(HttpSession session,
                                 ...
                                 //实现秒传：文件MD5，文件分片都在前端完成
                                 @VerifyParam(required = true) String fileMd5,//文件MD5值
                                 @VerifyParam(required = true) Integer chunkIndex,//第几个文件分片
                                 @VerifyParam(required = true) Integer chunks) //分片数量
    {
