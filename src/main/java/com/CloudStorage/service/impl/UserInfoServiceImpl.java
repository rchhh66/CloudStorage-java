...
import com.CloudStorage.entity.dto.QQInfoDto;
...
import com.CloudStorage.entity.enums.UserStatusEnum;
...
import com.CloudStorage.utils.JsonUtils;
import com.CloudStorage.utils.OKHttpUtils;
...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public SessionWebUserDto login(String email, String password) {
        ...
        //3.创建userinfo对象，更新登录时间
        UserInfo updateInfo = new UserInfo();
        updateInfo.setLastLoginTime(new Date());
        this.userInfoMapper.updateByUserId(updateInfo, userInfo.getUserId());
        //4.创建sessionWebUserDto用于存储用户登录信息，并作为返回参数
