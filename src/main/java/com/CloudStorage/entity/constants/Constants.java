package com.CloudStorage.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "CloudStorage:download:";

    public static final String REDIS_KEY_SYS_SETTING = "CloudStorage:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "CloudStorage:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "CloudStorage:user:file:temp:";
